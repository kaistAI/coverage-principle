            ...
            do
                ...
                do
                    ...
                    CUDA_VISIBLE_DEVICES=3 python "$PARENT_DIR/measure_cossim_coverage.py" \
                        ...
                        --output_dir "/mnt/nas/jinho/GrokkedTransformer/collapse_analysis/results/2-hop/${MODE}/${DATASET}_k<3/f${ATOMIC_IDX}/(${LAYER},${POS})/step${STEP}" &
                ...
                if [ "$(get_include_final "$MODEL_DIR" "$CONFIG_FILE")" = "true" ]; then
                    ...
                    CUDA_VISIBLE_DEVICES=3 python "$PARENT_DIR/measure_cossim_coverage.py" \
                        ...
                        --output_dir "/mnt/nas/jinho/GrokkedTransformer/collapse_analysis/results/2-hop/${MODE}/${DATASET}_k<3/f${ATOMIC_IDX}/(${LAYER},${POS})/stepfinal_checkpoint" &
