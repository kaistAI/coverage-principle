            ...
            do
                ...
                do
                    ...
                    python "$PARENT_DIR/plotting_collapse.py" \
                        ...
                        --output_dir "/mnt/nas/jinho/GrokkedTransformer/collapse_analysis/results/nontree/${MODE}/${DATASET}/f${ATOMIC_IDX}/(${LAYER},${POS})/step${STEP}" \
                        --save_plots \
                        --reduce_method pca \
                        --pca_scope global \
                        --pca_n 5 &
                ...
                if [ "$(get_include_final "$MODEL_DIR" "$CONFIG_FILE")" = "true" ]; then
                    ...
                    python "$PARENT_DIR/plotting_collapse.py" \
                        ...
                        --output_dir "/mnt/nas/jinho/GrokkedTransformer/collapse_analysis/results/nontree/${MODE}/${DATASET}/f${ATOMIC_IDX}/(${LAYER},${POS})/stepfinal_checkpoint" \
                        --save_plots \
                        --reduce_method pca \
                        --pca_scope global \
                        --pca_n 5 &
