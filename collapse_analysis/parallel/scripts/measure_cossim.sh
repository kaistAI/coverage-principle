...
process_model() {
    ...
    DEDUP_DIR="/mnt/nas/jinho/GrokkedTransformer/collapse_analysis/parallel/${MODE}/${SHORT_MODEL_DIR}"
            ...
            do
                ...
                do
                    ...
                    CUDA_VISIBLE_DEVICES=3 python "$PARENT_DIR/measure_cossim.py" \
                        ...
                        --output_dir "/mnt/nas/jinho/GrokkedTransformer/collapse_analysis/results/parallel/${MODE}/${DATASET}/f${ATOMIC_IDX}/(${LAYER},${POS})/step${STEP}" &
                done
                ...
                if [ "$(get_include_final "$MODEL_DIR" "$CONFIG_FILE")" = "true" ]; then
                    ...
                    CUDA_VISIBLE_DEVICES=3 python "$PARENT_DIR/measure_cossim.py" \
                        ...
                        --output_dir "/mnt/nas/jinho/GrokkedTransformer/collapse_analysis/results/parallel/${MODE}/${DATASET}/f${ATOMIC_IDX}/(${LAYER},${POS})/stepfinal_checkpoint" &
                fi
            done
            wait
        done
